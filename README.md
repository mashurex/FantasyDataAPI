...
or mobile app. This is a fork from the original [Gridiron Guru GitHub project](https://github.com/gridiron-guru/FantasyDataAPI) that has
been updated to work with the v2 NFL FantasyData APIs and add support for updated and new API request methods.
